...
private:
	bool Get(const ANSICHAR* InSection, const ANSICHAR* InKey, ini::IniField& OutField);
	bool Get(ini::IniFile& InTarget, const ANSICHAR* InSection, const ANSICHAR* InKey, ini::IniField& OutField);
